...
import 'package:ctb_attendance_monitoring/screens/teachers/components/accept_modal.dart';
...
class PendingTeachers extends StatefulWidget {
  @override
  State<PendingTeachers> createState() => _PendingTeachersState();
}

class _PendingTeachersState extends State<PendingTeachers> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder(
        ...
        builder: (context, snapshot) {
          List _students = !snapshot.hasData ? [] : snapshot.data!.where((s) => s["status"] == "pending").toList();

          return _students.isEmpty ?
            NoDataWidget() : Scrollbar(
            ...
            child: SingleChildScrollView(
              ...
              child: Table(
                ...
                children: <TableRow>[
                  ...
                  for(int x = 0; x < _students.length; x++)...{
                    TableRow(
                      ...
                      children: <Widget>[
                        ...
                        TableCell(
                          child: Padding(
                            ...
                            child: Center(
                              child: _students[x]["base64Image"] != "" ?
                              Image.memory(
                                base64Decode(_students[x]["base64Image"]),
                                width: 45,
                                height: 45,
                              ) :
                              Image(
                        ...
                        TableCell(child: Center(child: Text('${_students[x]["fname"]} ${_students[x]["lname"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                        TableCell(child: Center(child: Text('${_students[x]["age"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                        TableCell(child: Center(child: Text('${_students[x]["teacher_id"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                        TableCell(child: Center(child: Text('${_students[x]["email"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                        TableCell(child: Center(child: Text('${_students[x]["phone"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                        TableCell(child: Center(child: Text('${_students[x]["gender"]}',style: TextStyle(fontFamily: "Roboto_normal"),textAlign: TextAlign.center,))),
                            ...
                            onChanged: (value) {
                              ...
                              showDialog<void>(
                                  ...
                                  builder: (context) => AlertDialog(
                                      ...
                                      content: value.text == "Accept" ?
                                      AcceptModal(details: _students[x], onAccept: () {
                                        Map _payload = {
                                          "fname": _students[x]["fname"],
                                          "lname": _students[x]["lname"],
                                          "age": _students[x]["age"],
                                          "teacher_id": _students[x]["teacher_id"],
                                          "gender": _students[x]["gender"],
                                          "phone":_students[x]["phone"],
                                          "email": _students[x]["email"],
                                          "base64Image": _students[x]["base64Image"],
                                          "status": "accepted"
                                        };
                                        _teacherApis.edit(old_teacher_id: _students[x]["teacher_id"], payload: _payload).whenComplete((){
                                          Navigator.of(context).pop(null);
                                          _snackbarMessage.snackbarMessage(context, message: "New teacher successfully accepted!");
                                        });
                                      },) :
                                      DeleteModal(details: _students[x],onDelete: (){
                                        _teacherApis.delete(teacher_id: _students[x]["teacher_id"]).whenComplete((){
                                          Navigator.of(context).pop(null);
                                        });
                                      },)
                                  )
...
abstract class MenuItems {
  ...
  static const home = MenuItem(text: 'Accept', icon: Icons.edit);
  static const share = MenuItem(text: 'Reject', icon: Icons.delete);

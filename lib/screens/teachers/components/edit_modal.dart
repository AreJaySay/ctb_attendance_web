...
class _EditModalState extends State<EditModal> {
  ...
  void initState() {
    ...
    if(widget.isEdit){
      _fname.text = widget.details["fname"];
      _lname.text = widget.details["lname"];
            ...
            child: Column(
              ...
              children: [
                ...
                _materialbutton.materialButton(widget.isEdit ? "Update" : "Submit", (){
                  if(_fname.text.isEmpty || _lname.text.isEmpty || _age.text.isEmpty || _teacherid.text.isEmpty || _email.text.isEmpty || _phone.text.isEmpty || _age == "" ){
                    ...
                    Map _payload = {
                      ...
                      "phone": _phone.text,
                      "email": _email.text,
                      "students_handled_grade": widget.details["students_handled_grade"],
                      "students_handled_section": widget.details["students_handled_section"],
                      "base64Image": _base64,
                      "status": "accepted"
                    };
